		...
		<div class="card">
			...
			<div class="card-body">
				<form method="POST">
					...
					<button class="btn btn-info btn-sm sign_in_btn" type="submit" name="show_content">Show Content</button>
					<button class="btn btn-primary btn-sm sign_in_btn" type="submit" name="upload_content">Upload Content</button>
				</form>
			</div>
		</div>
	</div>
